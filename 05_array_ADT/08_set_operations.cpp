...
void array_union(const Array &arrA, const Array &arrB, Array &arrC)
{
    int i=0;
    int j=0;
    int k=0;
...
void array_intersection(const Array &arrA, const Array &arrB, Array &arrC)
{
    int i=0;
    int j=0;
    int k=0;
...
void array_difference(const Array &arrA, const Array &arrB, Array &arrC)
{
    int i=0;
    int j=0;
    int k=0;
...
//    array_union(arrA, arrB, arrC);
//    array_intersection(arrA, arrB, arrC);
    array_difference(arrA, arrB, arrC);
    display(arrC, "arrC");
